...
import {CheckCircle , TrendingUp, Wallet, FileText, BarChart3, ArrowRight, Zap, Target ,Star } from 'lucide-react';
...
// --- Component Data ---
 const results = [
   { icon: Wallet, label: 'Average Tax Savings', value: 'AED 45K+', color: 'bg-secondary' },
    { icon: TrendingUp, label: 'Financial Clarity', value: '100%', color: 'bg-secondary' },
    { icon: FileText, label: 'Compliance Rate', value: '99.8%', color: 'bg-secondary' },
    { icon: BarChart3, label: 'Time Saved', value: '20+ hrs/month', color: 'bg-secondary' }
  ];
        ...
        <section className="mb-32">
          ...
          >
            ...
            <h2 className="text-7xl sm:text-8xl c font-normal text-gray-900 mb-8 tracking-tight leading-none font-bold">
              Success <span className="font-['Playfair_Display',_serif] italic text-secondary">Stories</span> 
            </h2>
          ...
          >
            {testimonials.map((testimonial, idx) => (
              ...
              >
                ...
                {/* Testimonial Quote */}
                <p className="text-lg text-gray-800 mb-8 leading-relaxed flex-grow"> {/* Adjusted text size */}
                  "{testimonial.text}"
                </p>

                {/* Rating - Bottom of card, matching exact style */}
                <div className="pt-6 border-t border-gray-200">
                  <p className="text-gray-700 text-base font-semibold">Rating</p>
        ...
        {/* SECTION 4: Client Benefits (Checklist) */}
          ...
          {/* Client Benefits */}
                    ...
                    <div className="bg-secondary text-white p-16  rounded-[24px] ">
                      <h3 className="text-2xl font-bold  mb-6">Why Clients Choose Booker Accounting</h3>
                      <div className="space-y-4">
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            ...
                            <p className=" text-lg">No pressure. We diagnose your financial situation before recommending solutions. This ensures you only pay for what you actually need.</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-4">
                          <div className="w-3 h-3 bg-teal-600 rounded-full mt-2 flex-shrink-0"></div>
                          <div>
                            <h4 className="font-bold ">Custom Solutions, Not One-Size-Fits-All</h4>
                            <p className=" text-lg">Your plan is built specifically for your business, industry, and complexity. From AED 200 to AED 200K+, we scale to YOUR needs.</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-4">
                          <div className="w-3 h-3 bg-teal-600 rounded-full mt-2 flex-shrink-0"></div>
                          <div>
                            ...
                            <p className=" text-lg">We explain what we do, why we do it, and what you'll gain. No hidden fees. No surprises. Just honest, clear communication.</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-4">
                          <div className="w-3 h-3 bg-teal-600 rounded-full mt-2 flex-shrink-0"></div>
                          <div>
                            ...
                            <p className=" text-lg">Deep understanding of UAE tax regulations, VAT compliance, and corporate requirements across all emirates.</p>
                          </div>
                        </div>
                      </div>
                    </div>
