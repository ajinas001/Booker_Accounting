        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.97 }}
              className="inline-block bg-gradient-to-r from-cyan-500 to-secondary text-white text-lg font-semibold px-8 py-3 rounded-full shadow-md hover:shadow-xl transition-all duration-300"
            >
              Get Started
            </motion.a>
          </motion.div>
