...
const listItemVariants = {
    ...
    visible: { x: 0, opacity: 1, transition: { type: "spring", stiffness: 150, delay: 0.1 } },
};
...
const CoreIdentity = () => (
    <AnimatedContentBlock className={`p-8 md:p-12 text-gray-900 min-h-[400px]`}>
        <motion.h2 variants={itemVariants} className="text-4xl md:text-5xl font-light mb-4">Who We Are</motion.h2>
...
const MissionVision = () => (
    <AnimatedContentBlock className={`p-8 md:p-12 text-gray-900 min-h-[400px]`}>
        <motion.h2 variants={itemVariants} className="text-4xl md:text-5xl font-light mb-4">Our Mission & Vision</motion.h2>
        
        <motion.h3 variants={itemVariants} className="text-2xl font-semibold mt-6 mb-2">Our Mission</motion.h3>
        ...
        <motion.h3 variants={itemVariants} className="text-2xl font-semibold mt-6 mb-2">Our Vision</motion.h3>
        <motion.p variants={itemVariants} className="text-sm text-gray-700">
...
const SellingPoints = () => (
    <AnimatedContentBlock className={`p-8 md:p-12 text-gray-900 min-h-[400px]`}>
        <motion.h2 variants={itemVariants} className="text-4xl md:text-5xl font-light mb-6">Why Partner With Us</motion.h2>
