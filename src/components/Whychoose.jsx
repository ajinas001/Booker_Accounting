...
function Whychoose() {
  ...
  const features = [
    ...
    },
    {
      id: 3,
      title: "Our Promise",
      tagline: "Your success is our commitment",
      description: "We deliver transparent communication, proactive financial guidance, and strategic insights that help you make informed decisions for sustainable business growth.",
    ...
    <section className="relative py-20 lg:py-28 bg-[#f9f9f9] overflow-hidden text-slate-900">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute inset-0" style={{
          backgroundImage: 'radial-gradient(circle at 2px 2px, #94a3b8 1px, transparent 0)', // slate-400 dots
